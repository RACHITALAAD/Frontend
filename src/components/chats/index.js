...
const API_URL = "https://connecthivebackend.onrender.com/api/chat";
              ...
              {messages.length > 0 ? (
                <div className="flex flex-col space-y-2">
                  {messages.map((msg, index) => (
                    ...
                    >
                      <div
                        className={`p-2 rounded mb-2 max-w-xs ${msg.senderId === user.id ? "bg-blue-500 text-white" : "bg-gray-300 text-black"}`}
                      >
                        <b>
