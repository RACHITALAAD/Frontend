    ...
    const fetchApplications = async () => {
      try {
        const response = await axios.get(
          `https://connecthivebackend.onrender.com/api/application/job${jobId}`,
        );
      ...
      {selectedApplicant && (
        <div className={styles.profileModal}>
          <div className={styles.profileContent}>
            ...
            <p>
              <strong>Full Name:</strong> {selectedApplicant.full_name}
            </p>
            <p>
            ...
            {selectedApplicant.resume && (
              <p>
                ...
                <a
                  href={`https://connecthivebackend.onrender.com/uploads/${selectedApplicant.resume}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Download Resume
            ...
            {selectedApplicant.certifications && (
              <p>
                ...
                <a
                  href={`https://connecthivebackend.onrender.com/uploads/${selectedApplicant.certifications}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
