...
function Login() {
    ...
    const handleLogin = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch("https://connecthivebackend.onrender.com/api/auth/login", {
                method: 'POST',
    ...
    const handleRegister = async (e) => {
        ...
        try {
            const response = await fetch('https://connecthivebackend.onrender.com/api/auth/register', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
